...
#Created 2025-03-29 at 14:49

xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'C:\\Users\\maria\\Documents\\GitHub\\personal-website\\posts\\bayes_map_estimation_r\\models\\modelfit_dir7\\'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- 'C:/PsN-5.4.0/strawberry/perl/site/lib/PsN_5_4_0/R-scripts' # This is not used
