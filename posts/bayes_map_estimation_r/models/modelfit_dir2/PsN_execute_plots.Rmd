...
#Created 2025-03-31 at 11:43

xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'C:\\Users\\mklose\\Desktop\\GitHub\\personal-website\\posts\\bayes_map_estimation_r\\models\\modelfit_dir2\\'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- 'C:/PsN-5.5.0/strawberry/perl/site/lib/PsN_5_5_0/R-scripts' # This is not used
raw.results.file <- 'raw_results_1cmt_iv_map_est.csv'
theta.labels <- c('1 TVCL','2 TVV')
theta.fixed <- c(TRUE,TRUE)
omega.labels <- c('1 OM_CL')
omega.fixed <- c(TRUE)
sigma.labels <- c('1 SIG_PROP','2 SIG_ADD')
sigma.fixed <- c(TRUE,TRUE)
n.eta <- 1
n.eps <- 2
