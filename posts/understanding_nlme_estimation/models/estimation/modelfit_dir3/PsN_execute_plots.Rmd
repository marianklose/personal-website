...
#Created 2025-01-16 at 13:50

xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'C:\\Users\\mklose\\Desktop\\GitHub\\personal-website\\posts\\understanding_nlme_estimation\\models\\estimation\\modelfit_dir3\\'
results.directory <- '..'
