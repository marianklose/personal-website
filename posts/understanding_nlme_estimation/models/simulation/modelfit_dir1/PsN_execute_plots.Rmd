...
#Created 2024-12-30 at 22:46

xpose.runno <- ''
toolname <- 'execute'
pdf.filename <- paste0('PsN_',toolname,'_plots.pdf')
working.directory<-'C:\\Users\\maria\\Desktop\\G\\Mitarbeiter\\Klose\\Miscellaneous\\NLME_reproduction_R\\models\\simulation\\modelfit_dir1\\'
results.directory <- '..'
subset.variable<-NULL
tab.suffix <- '' 
rscripts.directory <- 'C:/PsN-5.4.0/strawberry/perl/site/lib/PsN_5_4_0/R-scripts' # This is not used
raw.results.file <- 'raw_results_1cmt_iv_sim.csv'
