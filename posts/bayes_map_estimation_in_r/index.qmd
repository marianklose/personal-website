...
For our example and reference, we'll use a simple one-compartment IV model with first-order kinetics, previously fitted to similar data (@kloseMyAttemptUnderstand2025). Here's a sketch of the simple model structure:
